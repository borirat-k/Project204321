package com.deknerdvariety.prayat.schedule.timetable
    ...
    private fun calTime(startTime: String, stopTime: String, startList: Int, idCourse: String) {
        ...
        if(clearXml == 0){
            ...
            if (diff < 1.1) {
                ...
                labelList[startList].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5].setBackgroundColor(resources.getColor(R.color.colorWhite))
                //findViewById<TextView>(R.id.eight1).setText(idCourse)
                labelList[startList + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
            } else if (1.1 < diff && diff < 1.9) {
                //settext
                ...
                labelList[startList].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 5].setBackgroundColor(resources.getColor(R.color.colorWhite))

                labelList[startList + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 5 + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
            } else if (1.9 < diff && diff < 2.1) {
                //updateCompleteRow(startList % 5, idCourse)
                labelList[startList + 5].text = ""
                labelList[startList + 5 + 3].text = ""
                ...
                labelList[startList + 5].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 5].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 5 + 5].setBackgroundColor(resources.getColor(R.color.colorWhite))

                labelList[startList + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 5 + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
                labelList[startList + 5 + 5 + 5 + 3].setBackgroundColor(resources.getColor(R.color.colorWhite))
            }
        }
    }
