...
class MainActivity : AppCompatActivity() {
    ...
    private var byteA:ByteArray? = null
    ...
    private fun takePicture(): () -> Unit = {
        val photoResult = fotoapparat
                .autoFocus()
                .takePicture()
                //.saveToFile(File(getExternalFilesDir("photo"),"photo.jpg"))
                ...
                .whenAvailable { photo ->
                    photo
                            ?.let {
                                ...
                                intent = Intent(applicationContext,NewActivity::class.java)
                                intent.putExtra("data",getExternalFilesDir("photos").toString()+"/photo.jpg")
