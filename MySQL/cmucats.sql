...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2018 at 05:55 AM
...
('204321', '#2', '2018-08-22', '2018-08-28', 45),
...
(610710176, 3, '204100', '#2', 0, '0000-00-00', '', 0, '', '', 0, ''),
...
(611610158, 3, '204100', '#2', 0, '0000-00-00', '', 0, '', '', 0, ''),
...
--
ALTER TABLE `teach`
  ADD PRIMARY KEY (`Tid`,`Cid`) USING BTREE,
  ADD KEY `Cid` (`Cid`);
