...
//            }
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        String dateMF[] = {"Mon","Tur","Wed","Thu","Fri"};
        //for (int dayNumber=leftDaysWithGaps+1; dayNumber <= 5; dayNumber++) {
        for (int dayNumber=leftDaysWithGaps+1; dayNumber < 6; dayNumber++) {
            // Check if the day is today.
            day = (Calendar) today.clone();
            day.add(Calendar.DATE, dayNumber - 1);
            boolean sameDay = isSameDay(day, today);
            ...
            // Draw the day labels.
            String dayLabel = dateMF[dayNumber-1];//getDateTimeInterpreter().interpretDate(day);
            if (dayLabel == null)
