...
class JsonDownloadDetailSchedule(var context: Context, private var phpUrl:String, var tc_id:Int) : AsyncTask<Void, Void, String>() {
    ...
    private fun download():String{
        ...
        try{
            ...
            var data: String = URLEncoder.encode("tc_id", "UTF-8") + "=" + URLEncoder.encode(tc_id.toString(), "UTF-8")
            writer.write(data)
            writer.flush()
            writer.close()
            ops.close()
