...
class parserattendance (private var c: Context, private var jsonData: String,
                    private var rv: RecyclerView): AsyncTask<Void, Void, Boolean>() {


    val courses = ArrayList<attendance>()
