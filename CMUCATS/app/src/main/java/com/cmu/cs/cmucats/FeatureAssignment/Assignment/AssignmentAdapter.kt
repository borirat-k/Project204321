...
class AssignmentAdapter(val assignList: ArrayList<Assignment>, context: Context, private var courseID: String): RecyclerView.Adapter<AssignmentAdapter.ViewHolder>() {
