...
class AssignmentAdapter(val assignList: ArrayList<Assignment>, context: Context, private var course: String): RecyclerView.Adapter<AssignmentAdapter.ViewHolder>() {
