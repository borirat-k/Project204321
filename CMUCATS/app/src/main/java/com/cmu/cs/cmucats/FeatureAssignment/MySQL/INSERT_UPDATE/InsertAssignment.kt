...
class InsertAssignment(private var c: Context, private var urlAdress: String,
                       private var courseID: String, private var assignmentID: String,
                       private var startDate: String, private var deadLine: String, private var maxScore: String): AsyncTask<Void, Void, Boolean>() {
