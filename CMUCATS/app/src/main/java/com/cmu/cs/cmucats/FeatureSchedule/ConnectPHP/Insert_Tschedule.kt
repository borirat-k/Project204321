...
class Insert_Tschedule(var context: Context, private var phpUrl: String,var user_id:Int,var semester:String) : AsyncTask<Void, Void, String>() {
    ...
    private fun download(): String {
        ...
        try {
            ...
            var data: String = URLEncoder.encode("user_id", "UTF-8") + "=" + URLEncoder.encode(user_id.toString(), "UTF-8")+"&&"+URLEncoder.encode("semester", "UTF-8")+"="+URLEncoder.encode(semester, "UTF-8")
            writer.write(data)
            writer.flush()
            writer.close()
            ops.close()
