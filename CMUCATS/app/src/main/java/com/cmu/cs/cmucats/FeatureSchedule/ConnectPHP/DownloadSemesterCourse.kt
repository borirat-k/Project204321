...
class DownloadSemesterCourse(var context: Context, private var phpUrl:String,var user_id:Int): AsyncTask<Void, Void, String>() {
    ...
    override fun onPostExecute(jsonData: String) {
        ...
        if(jsonData!!.startsWith("URL ERROR")){
            ...
            ParserSemester(context,jsonData).execute()
        }
    }
